...
public class Mp3Recorder {
    ...
    private String outputPath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/AudioRecorder/";
    private String fileName = "recording.mp3";
    private boolean micHasVolume = false;
    ...
    public void setOutputFile(String outputPath, String fileName) {
        this.outputPath = outputPath;
        this.fileName = fileName;
    }

    public void setRecordStateListener(RecordStateListener mRecordStateListener) {
        this.mRecordStateListener = mRecordStateListener;
    }
    ...
    public void startRecording() throws IOException {
        ...
        timer = new CountDownTimer(500, 50) {
            ...
            public void onFinish() {
                if (!micHasVolume && mRecordStateListener != null) {
                    mRecordStateListener.onMicNoVolume();
                }
            }
        };
    ...
    public void stopRecording() throws IOException {
        ...
        if (isRecording && mRecordStateListener != null)
            mRecordStateListener.onStopRecording(micHasVolume);
        isRecording = false;
    }
     ...
     * @param r
     */
    private double countVolume(int r) {
        long v = 0;
     ...
     * @param r
     */
    private void checkVolume(int r) {
        double volume = countVolume(r);
        if (volume > 0)
            micHasVolume = true;
    }
    ...
    public interface RecordStateListener {
        ...
        void onStopRecording(boolean success);
    }
}